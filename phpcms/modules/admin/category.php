    ...
    public function edit() {
        ...
        if(isset($_POST['dosubmit'])) {
            ...
            $arr_ext = array(
                ...
                'company_title',
                'company_description',
                'company_possess_title',
                'company_possess_description',
                'company_tenet_title',
                'company_tenet__description',
                'company_spirit_title',
                'company_spirit_description',
                'company_mission_title',
                'company_mission_description',
                'company_clture_title',
                'company_clture_description'
            );
            $ext_json = array();
            foreach ($arr_ext as $ext) {
                $ext_json[$ext] = trim($_POST['info'][$ext]);

                unset($_POST['info'][$ext]);
            }
            $ext_data = array(
                'data' => json_encode($ext_json, JSON_UNESCAPED_UNICODE),
            );
            ...
            $model_ext = pc_base::load_model('category_ext_model');
            $ext_data = $model_ext->select(array('catid' => $catid));
            $ext_data = json_decode($ext_data[0]['data'], true);
