...
<!--		<textarea name="info[description]" maxlength="255" style="width:300px;height:60px;">--><?php //echo $description;?><!--</textarea>-->
    ...
    <tr>
        ...
        <td>
            <script type="text/javascript" src="/statics/js/ckeditor/ckeditor.js"></script>
            <textarea name="info[approve]" cols="50" rows="8" id="approve"><?php echo $approve;?></textarea>
            <script type="text/javascript">
    ...
    <tr>
        ...
        <td>
            <script type="text/javascript" src="/statics/js/ckeditor/ckeditor.js"></script>
            <textarea name="info[expert]" cols="50" rows="8" id="expert"><?php echo $expert;?></textarea>
            <script type="text/javascript">
...
<tr>
    ...
    <?php if ($catid == 9) { ?>
        <tr>
            <th>LOGO：</th>
            <td><?php echo form::images('info[company_logo]', 'company_logo', $image, 'content');?></td>
        </tr>
        <tr>
            <th>公司标题：</th>
            <td><input type="text" name="info[company_title]" id="company_title" class="input-text" value="<?php echo $ext_data['company_title']; ?>"></td>
        </tr>
        <tr>
            <th>公司内容：</th>
            <td>
                <textarea name="info[company_description]" maxlength="255" style="width:300px;height:60px;"><?php echo $ext_data['company_description']; ?></textarea>
            </td>
        </tr>
        <tr>
            <th>“企业定位”标题：</th>
            <td><input type="text" name="info[company_possess_title]" id="company_possess_title" class="input-text" value="<?php echo $ext_data['company_possess_title']; ?>"></td>
        </tr>
        <tr>
            <th>“企业定位”内容：</th>
            <td>
                <textarea name="info[company_possess_description]" maxlength="255" style="width:300px;height:60px;"><?php echo $ext_data['company_possess_description']; ?></textarea>
            </td>
        </tr>
        <tr>
            <th>“企业宗旨”标题：</th>
            <td><input type="text" name="info[company_tenet_title]" id="company_possess_title" class="input-text" value="<?php echo $ext_data['company_tenet_title']; ?>"></td>
        </tr>
        <tr>
            <th>“企业宗旨”内容：</th>
            <td>
                <textarea name="info[company_tenet__description]" maxlength="255" style="width:300px;height:60px;"><?php echo $ext_data['company_tenet__description']; ?></textarea>
            </td>
        </tr>
        <tr>
            <th>“企业精神”标题：</th>
            <td><input type="text" name="info[company_spirit_title]" id="company_possess_title" class="input-text" value="<?php echo $ext_data['company_spirit_title']; ?>"></td>
        </tr>
        <tr>
            <th>“企业精神”内容：</th>
            <td>
                <textarea name="info[company_spirit_description]" maxlength="255" style="width:300px;height:60px;"><?php echo $ext_data['company_spirit_description']; ?></textarea>
            </td>
        </tr>
        <tr>
            <th>“企业使命”标题：</th>
            <td><input type="text" name="info[company_mission_title]" id="company_possess_title" class="input-text" value="<?php echo $ext_data['company_mission_title']; ?>"></td>
        </tr>
        <tr>
            <th>“企业使命”内容：</th>
            <td>
                <textarea name="info[company_mission_description]" maxlength="255" style="width:300px;height:60px;"><?php echo $ext_data['company_mission_description']; ?></textarea>
            </td>
        </tr>
        <tr>
            <th>“企业文化”标题：</th>
            <td><input type="text" name="info[company_clture_title]" id="company_possess_title" class="input-text" value="<?php echo $ext_data['company_clture_title']; ?>"></td>
        </tr>
        <tr>
            <th>“企业文化”内容：</th>
            <td>
                <textarea name="info[company_clture_description]" maxlength="255" style="width:300px;height:60px;"><?php echo $ext_data['company_clture_description']; ?></textarea>
            </td>
        </tr>
    <?php } ?>
    <!--关于我们页面添加的文本项-->
