...
<div class="bk15"></div>
    <fieldset>
        ...
        <table width="100%"  class="table_form">
            ...
            <tr>
                <th width="80">首页LOGO：</th>
                <td class="y-bg"><?php echo form::images('setting[index_logo]', 'index-image', '', 'content');?></td>
            </tr>
            <tr>
                <th>Copyright：</th>
...
<div class="bk15"></div>
    <fieldset>
        ...
        <table width="100%"  class="table_form">
            <tr>
                <th width="80">公司全称：</th>
                <td class="y-bg"><input type="text" class="input-text" name="setting[company_name]" id="company_name" style="width: 90%;" /></td>
            </tr>
            <tr>
                <th>地址：</th>
                <td class="y-bg"><input type="text" class="input-text" name="setting[address]" id="address" style="width: 90%;" /></td>
            </tr>
            <tr>
                <th>电话：</th>
                <td class="y-bg"><input type="text" class="input-text" name="setting[telephone]" id="telephone" style="width: 90%;" /></td>
            </tr>
            <tr>
                <th>传真：</th>
                <td class="y-bg"><input type="text" class="input-text" name="setting[fax]" id="fax" style="width: 90%;" /></td>
            </tr>
            <tr>
                <th>邮箱：</th>
                <td class="y-bg"><input type="text" class="input-text" name="setting[email]" id="email" style="width: 90%;" /></td>
            </tr>
        </table>
    </fieldset>
    <div class="bk15"></div>
