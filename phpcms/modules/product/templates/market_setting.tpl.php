    ...
    <form method="post" action="?m=product&c=market&a=setting" name="myform" id="myform">
        ...
        <table id="tbl-cn" class="table_form" width="100%" cellspacing="0">
            ...
            <tr>
                ...
                <td><input name="market[title]" id="title" class="input-text" type="text" size="50" style="width: 350px;" value="<?php echo !empty($info) ? $info['title'] : ''; ?>"></td>
            </tr>
            <tr>
                <th><strong>描述：</strong></th>
                <td><textarea name="market[description]" id="description" style="width: 350px;height:50px;"><?php echo !empty($info) ? $info['description'] : ''; ?></textarea></td>
            </tr>
            <tr>
